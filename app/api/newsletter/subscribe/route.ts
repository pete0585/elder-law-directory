...
const NICHE = 'elder-law' as const
const DIRECTORY_SLUG = 'elder-law-directory' as const
const NEWSLETTER_NAME = 'The Later-Life Law Letter' as const
const CONFIRM_URL_BASE = 'https://www.elderlawyerdirectory.com/newsletter/confirm'
